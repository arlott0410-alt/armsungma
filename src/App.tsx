      ...
      <footer className="border-t border-white/10 py-10">
        <div className="container flex flex-col items-start justify-between gap-4 text-sm text-white/50 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap gap-4">
            <a className="link-underline" href={whatsappLink} target="_blank" rel="noopener noreferrer">
              WhatsApp
            </a>
            <a className="link-underline" href={telegramLink} target="_blank" rel="noopener noreferrer">
              Telegram
            </a>
            <a className="link-underline" href={phoneLink} target="_blank" rel="noopener noreferrer">
              {t('cta.phone')}
            </a>
          </div>
        </div></footer>
